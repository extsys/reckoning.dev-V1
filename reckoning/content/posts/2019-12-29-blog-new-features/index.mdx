...
| + Using [prism-react-renderer](https://github.com/FormidableLabs/prism-react-renderer) to enable custom code blocks with copy to clipboard button
...
<div className="Image__Small">
  <img src="https://res.cloudinary.com/sadanandsingh/image/upload/v1579064368/medium-share_ancyk2.gif" alt="share" />
  <figcaption>
    <strong>
      Picture Courtesy:
