...
const Newsletter: React.FunctionComponent<NewsletterProps> = ({ ...props }) => {
  ...
  return (
    <NewsletterWrapper {...props}>
      <NewsletterInnerWrapper>
        <NewsletterTitle>Get The Best Of Posts Delivered To Your Inbox</NewsletterTitle>
        <NewsletterDescription>Subscribe to my newsletter and stay updated.</NewsletterDescription>
