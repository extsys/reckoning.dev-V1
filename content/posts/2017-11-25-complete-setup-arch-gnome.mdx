...
<div class='filename'>cat /proc/partitions</div>
...
<div class='filename'>/etc/hosts</div>
...
<div class='filename'>vi /etc/mkinitcpio.conf</div>
...
<div class='filename'>vim /boot/loader/loader.conf</div>
...
<div class='filename'>vim /boot/loader/entries/arch.conf</div>
...
<div class='filename'>vim /etc/systemd/network/50-wired.network</div>
...
<div class='filename'>vim /etc/systemd/timesyncd.conf</div>
...
<div class='filename'>/etc/pacman.d/hooks/nvidia.hook</div>
...
<div class='filename'>$HOME/.gitconfig</div>
