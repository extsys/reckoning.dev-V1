...
[[tldr | TL;DR ]]
| [Comet.ml](comet) is a great step towards management of deep learning experiments. The look and feel is quite ahead of the competition. I recommend it highly for _small projects_. I would wait for it to be more stable and feature rich to use it on larger projects.

[[update | UPDATE]]
| Recently, I was contacted by [Gideon Mendels, CEO of comet.ml](https://www.linkedin.com/in/mendels/) regarding the issues that I reported on this post. He notified me that some of the issues that I had faced was due to some temporary issue that they were facing. I have verified that and updated my review below.
...
<ZoomImage src='https://res.cloudinary.com/sadanandsingh/image/upload/v1555803192/comet/exp_list_dhgqxu.png'></ZoomImage>
...
<ZoomImage src='https://res.cloudinary.com/sadanandsingh/image/upload/v1555804423/comet/exp_charts_qywcey.png'></ZoomImage>
...
<ZoomImage src='https://res.cloudinary.com/sadanandsingh/image/upload/v1555804851/comet/gpu-props_l0rwsd.png'></ZoomImage>

A really cool feature that I really like, is to get steps to reproduce to the results for a given
experiment.

<ZoomImage src='https://res.cloudinary.com/sadanandsingh/image/upload/v1555805270/comet/reproduce_exp_x0zeaf.png'></ZoomImage>
...
<ZoomImage src='https://res.cloudinary.com/sadanandsingh/image/upload/v1557038035/comet/Screen_Shot_2019-05-04_at_11.33.09_PM_tpnyyl.png'></ZoomImage>
...
<ZoomImage src='https://res.cloudinary.com/sadanandsingh/image/upload/v1557038994/comet/dirty_compare_qo6i7x.png'></ZoomImage>
...
<ZoomImage src='https://res.cloudinary.com/sadanandsingh/image/upload/v1557039275/comet/metrics_compare_akmutf.png'></ZoomImage>
...
<ZoomImage src='https://res.cloudinary.com/sadanandsingh/image/upload/v1557084082/comet/clean_compare.png'></ZoomImage>
